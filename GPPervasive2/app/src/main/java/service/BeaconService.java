...
public class BeaconService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        Log.d(TAG_DEBUG_APP+TAG_DEBUG, "onCreate() Service Started");
        ...
        if(created == 0){
            ...
            Log.d(TAG_DEBUG_APP+TAG_DEBUG, "created==0, we have called initializedBeaconManager()");
            created++;
        }else{
            Log.d(TAG_DEBUG_APP+TAG_DEBUG, "created!=0");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
       // Toast.makeText(this, "onStartCommand() Service Started", Toast.LENGTH_SHORT).show();
        Log.d(TAG_DEBUG_APP+TAG_DEBUG, "onStartCommand() Service Started");
        return START_STICKY;
    }
    ...
    public void onDestroy() {
        ...
        Log.d(TAG_DEBUG_APP+TAG_DEBUG, "onDestroy()-Service Destroyed");
    ...
    private void initializedBeaconManager(){
        ...
        beaconManager.setMonitoringListener(new BeaconManager.MonitoringListener() {
            ...
            public void onEnteredRegion(Region region, List<Beacon> list) {
                Log.d(TAG_DEBUG_APP+TAG_DEBUG, "onEnteredRegion");
            ...
            public void onExitedRegion(Region region) {
                ...
                if(n1 == null) {
                    Log.d(TAG_DEBUG_APP+TAG_DEBUG, "n1 == null");
                    utils.Utils.deleteNotification(id_not,service);
                    ...
                    Log.d(TAG_DEBUG_APP+TAG_DEBUG, "n1 != null,onExitedRegion(), c'è già la notifica");
                }
